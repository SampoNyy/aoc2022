...
fn main(){
    ...
    let mut stacks: Vec<Vec<char>> = Vec::from([Vec::from(['B','Q','C']),Vec::from(['R','Q','W','Z']),Vec::from(['B','M','R','L','V']),
                                    Vec::from(['C','Z','H','V','T','W']),Vec::from(['D','Z','H','B','N','V','G']),Vec::from(['H','N','P','C','J','F','V','G']),
                                    Vec::from(['D','G','T','R','W','Z','S']),Vec::from(['C','G','M','N','B','W','Z','P']),Vec::from(['N','J','B','M','W','Q','F','P'])]);
